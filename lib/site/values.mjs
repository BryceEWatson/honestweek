...
const TRUSTED_ROOTS = ['chart', 'sessions', 'provenance', 'projectStats', 'repos', 'meta'];
...
/** Collect every finite number reachable from the trusted derived roots. Exported
 *  so the transform-mode numeric fence seeds from EXACTLY the same set. */
export function seedVerifiedNumbers(siteModel) {
