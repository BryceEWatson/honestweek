...
/** The bar a finding must clear to be worth a human's attention. Calibrated against
 *  what the known-good sessions actually scored rather than chosen a priori — see
 *  the calibration table in docs/mining.md. */
