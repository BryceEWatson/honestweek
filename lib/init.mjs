...
const EXAMPLE_CONFIG = {
  ...
  curation: { maxItems: 12, automaticMinScore: 2, categoryCaps: { prompts: 2, ideas: 2, techniques: 3, decisions: 2, reversals: 1, nextSteps: 2 } },
...
export function writeInitFiles(cwd, config, { force = false } = {}) {
  ...
  for (const entry of [...PROMPT_GITIGNORE, ...DIGEST_GITIGNORE]) {
