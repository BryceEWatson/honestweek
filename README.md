...
| `curation.*` | Local weekly-selection policy. Defaults target 12 items with caps of 2 prompts, 2 ideas, 3 techniques, 2 decisions, 1 reversal, and 2 next steps. The automatic floor is 2. Explicit keeps in any digest category are never silently dropped, but they never bypass receipt or privacy gates. |
